      ...
      <main className="max-w-3xl mx-auto px-6 py-16 flex flex-col gap-16">
        ...
        <section>
          ...
          <div className="flex flex-col gap-4 text-gray-600 leading-relaxed">
            <p>
              Après une classe préparatoire parisienne, j'ai intégré un <strong className="text-gray-900">triple diplôme international</strong> entre <strong className="text-gray-900">l'EDHEC</strong>, <strong className="text-gray-900">SKKU à Séoul</strong> et <strong className="text-gray-900">UC Berkeley</strong> aux États-Unis.
            </p>
            <p>
